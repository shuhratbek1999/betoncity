const Equipment = () => {
  ...
  return (
    <div className="container-base h-[600px] flex flex-col sm:flex-row justify-center mt-[500px] sm:mt-80">
      <div className="info w-full lg:w-6/12">
        ...
        <h4 className="font-space-grotesk text-center sm:text-left text-2xl font-normal text-secondary my-2 sm:my-10">
      ...
      <div className="equipments w-full lg:w-5/12 flex flex-col items-start gap-4">
        {equipments.map((ex) => (
          <div
            key={ex.id}
            className="flex flex-col sm:flex-row justify-center gap-4 border-b-2 border-b-orange pb-4"
          >
            <div className="eq_img w-10/12 sm:w-1/2">
              <img className="w-full" src={ex.img} alt={ex.name} />
            </div>
